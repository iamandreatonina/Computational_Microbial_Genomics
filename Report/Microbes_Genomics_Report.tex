...
Each SGB strain was found to contain an average of 1317 genes that are present in every strain (core genome), plus 8407 genes that are absent in more than one strains (strain $<$ 30) (accessory genome). This can be seen in the Figure \ref{fig:pangenome2}, showing the frequency plot of the genes per genome.
...
DA COMMENTARELE IMMAGINI OTTENUTE CON R STUDIO -> PER DIRE SE IL PANGENOME è APERTO O CHIUSO
\begin{figure}[ht]
\centering
\includegraphics[scale=0.2]{Graphs/conserved\_vs\_total\_genes.png}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.2]{Graphs/unique\_vs\_new\_genes.png}
