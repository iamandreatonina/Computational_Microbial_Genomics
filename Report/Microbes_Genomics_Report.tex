...
\chapter{Conclusion}
Thanks to this project it was possible to obtain an insight of the metagenome workflow and the main analysis that are neeed when dealing with unkown genomes.
...
We than were able to perform a pangenome analysis and hypotize that the pangenome of our SGB is closed as the addition of new genomes gives us little to no information as shown in the Figure \ref{fig:pangenome4}. Also, it was possible to identify the genes shared by at least 90\% of our MAGs, the core genome, these correspons to $\sim$ 15\% of the total gene.
From the taxonomix assigment of the uSGB it was possible to identify the \textit{} family and specifically the \textit{} species.
